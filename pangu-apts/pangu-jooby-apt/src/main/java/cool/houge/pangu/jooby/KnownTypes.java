...
class KnownTypes {
    ...
    KnownTypes() {
        ...
        add(new DateTimeType(), Instant.class, OffsetDateTime.class, ZonedDateTime.class, Timestamp.class,
            java.util.Date.class, LocalDateTime.class);
        ...
        add(new BinaryType(), byte[].class, InputStream.class, FileUpload.class);
    }
    ...
    private class BinaryType implements KnownType {
